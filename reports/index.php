                ...
                <section class="bg-white rounded-xl border border-slate-200 shadow-sm overflow-hidden">
                    <div class="flex items-center justify-between gap-3 px-4 py-3 border-b border-slate-200">
                        ...
                        <div class="flex gap-2">
                            <a href="export_excel.php?<?= htmlspecialchars($exportQuery, ENT_QUOTES, 'UTF-8'); ?>" class="inline-flex items-center rounded-lg border border-slate-300 px-3 py-2 text-xs font-semibold text-slate-700 hover:bg-slate-100">
                                Export Excel
                            </a>
